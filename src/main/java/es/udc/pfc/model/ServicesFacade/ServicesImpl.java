...
import es.udc.pfc.hieroglyphs.CartoucheType;
import es.udc.pfc.hieroglyphs.Shade;
import es.udc.pfc.hieroglyphs.ShadeType;
import es.udc.pfc.model.Query.HieroQuery;
import es.udc.pfc.model.Query.LatinQuery;
